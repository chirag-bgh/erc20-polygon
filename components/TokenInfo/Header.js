...
class Header extends React.Component {
    ...
    // its a good idea to do the querying at the last step
    // of the mounting phase(when a component is mounted t0 DOM )
    //componentDidMount is where it is most suitable to call this.setState
